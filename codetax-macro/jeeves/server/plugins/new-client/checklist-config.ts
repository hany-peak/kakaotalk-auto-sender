...
export const CHECKLIST_ITEMS: ChecklistItemDefinition[] = [
  ...
  { key: 'contract', label: '기장계약서', step: 6, kind: 'enum',
    states: ['none', '전달완료', '해당없음'],
    doneStates: ['전달완료', '해당없음'],
    description: '기장계약서 거래처 전달 완료 (해당없음 포함 완료 처리)' },
  { key: 'feeBillingDate', label: '수수료 청구일', step: 7, kind: 'value',
    valueKind: 'date',
    description: 'CMS 출금일. 매월 25일 고정이 기본' },
  { key: 'paymentMethod', label: '결제방식', step: 8, kind: 'enum',
    states: ['none', 'CMS', '계좌이체', '해당없음'],
    description: 'CMS 자동이체 / 직접 입금 / 신고대리' },
  { key: 'cms', label: 'CMS', step: 9, kind: 'binary',
    states: ['none', 'done'],
    description: '더빌 자동출금 등록 완료 (Airtable 체크박스와 동기화)' },
  { key: 'hometaxDelegation', label: '홈택스 수임', step: 10, kind: 'enum',
    states: ['none', '수임신청', '수임완료'],
    doneStates: ['수임완료'],
    description: '홈택스 수임 진행 상태' },
  { key: 'ediDelegation', label: 'EDI 수임', step: 11, kind: 'enum',
    states: ['none', '해지요청', '등록대기', '등록완료', '해당없음'],
    doneStates: ['등록완료', '해당없음'],
    description: '국민연금/건강보험공단 EDI 수임등록 상태' },
  { key: 'businessAccount', label: '사업용계좌', step: 12, kind: 'enum',
    states: ['none', '자료요청', '등록완료', '해당없음'],
    doneStates: ['등록완료', '해당없음'],
    description: '홈택스 사업용계좌 등록 상태' },
  { key: 'creditCard', label: '신용카드', step: 13, kind: 'enum',
    states: ['none', '등록완료', '등록실패', '해당없음'],
    doneStates: ['등록완료', '해당없음'],
    description: '사업용카드 등록 상태' },
  { key: 'cashReceiptStore', label: '현영가맹점', step: 14, kind: 'binary',
    states: ['none', 'done'],
    description: '현금영수증 가맹점 등록 완료 (Airtable 체크박스와 동기화)' },
  { key: 'assignee', label: '실무자', step: 15, kind: 'enum',
    states: ['none', '0-1.정주희', '1-1.김다원', '미배정'],
    description: '담당자 (Airtable multipleSelects 연동)' },
  { key: 'wemembers', label: '위멤버스', step: 16, kind: 'binary',
    states: ['none', 'done'],
    description: '위멤버스 수임처 거래처 등록 완료' },
  { key: 'semoreport', label: '세모리포트', step: 17, kind: 'binary',
    states: ['none', 'done'],
    description: '세모리포트 등록 완료' },
  { key: 'onboardingComplete', label: '수임완료', step: 18, kind: 'binary',
    states: ['none', 'done'],
